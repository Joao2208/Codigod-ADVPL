...
Local cYesoNot  := GetMV("MV_CT105MS")
Local cCont
Local oDataMV    
Local oDiasMM   
Local oDataMM
...
@ 156,030 SAY "MV_CT105MS: "   SIZE 50,07 PIXEL OF oDlgPar
@ 155,081 ComboBox oListBox VAR cYesoNot ITEMS {"Sim","Nao"} SIZE 30,10 PIXEL OF oDlgPar

DEFINE SBUTTON FROM 0175,108 TYPE 1 ACTION (GrvDatas(dUlMes,dDataCtb,dDataFat,dDataFin,dDataFis,dDataMov,nLimDias,cDtCont,cAltLcto,cCont,cYesoNot),oDlgPar:End()) ENABLE OF oDlgPar
...
Static Function GrvDatas(dUlMes,dDataCtb,dDataFat,dDataFin,dDataFis,dDataMov,nLimDias,cDtCont,cAltLcto,cCont,cYesoNot)
